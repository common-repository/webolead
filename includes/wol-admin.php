...
class Wol_Admin {
    ...
    public function wol_settings_page() {
        ...
        add_settings_section('wol_webolead_example', __('WebOLead code example', 'webolead'), array($this, 'wol_webolead_example'), 'webolead');
    ...
    public function wol_webolead_example() {
        echo '<p>' . __('You can find WebOLead site ID in the WebOLead code as in this example below', 'webolead') . '</p>';
